...
plt.annotate(f'Final Test Accuracy: {final_val_accuracy:.4f}', xy=(epochs - 1, final_val_accuracy), xytext=(epochs - 10, final_val_accuracy + 0.0), arrowprops=dict(arrowstyle='->'))
plt.xlabel('Epoch')
plt.ylabel('Accuracy')
